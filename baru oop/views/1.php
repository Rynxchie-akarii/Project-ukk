...
<head>
    ...
    <link rel="stylesheet" href="../views/style/sidebar.css"> <!-- Link to sidebar CSS -->
</head>
<body>
...
<div class="sidebar">
    <div class="sidebar-container">
        ...
        <ul class="sidebar-links">
            ...
            <li><a href="supplier.php" class="nav-link">Tambah Data</a></li>
            <li><a href="1.php" class="nav-link">Supplier</a></li>
            <?php if ($loggedIn) { ?>
                <li><a href="v_login.php?aksi=logout" class="nav-link">Logout</a></li>
            <?php } else { ?>
                <li><a href="v_login.php" class="nav-link">Login</a></li>
            <?php } ?>
        </ul>
    </div>
</div>
        ...
        <table>
            ...
            foreach ($dataHp as $row) : ?>
                <tr>
                    ...
                    <td>
                       <a href="edit.php?id=<?= $row['id']; ?>" style="color: #3498db; font-weight: bold; text-decoration: none;" onmouseover="this.style.color='#2980b9';" onmouseout="this.style.color='#3498db';">Edit</a> |
